...
describe("Pf2eDataService / Search and Lookup", () => {
  ...
  it("supports lookup, listing, filtering, and derived metadata", async () => {
    ...
    expect(civicNpcNames).toEqual(expect.arrayContaining(["Boggard Mire Scout", "Fortress Warden", "Guild Engineer", "Ship Captain", "Wealthy Vigilante"]));
    ...
    expect(fortressWarden?.derivedTags).toEqual(expect.arrayContaining(["fortress_setting", "profession_npc", "civic_npc", "combatant_npc"]));
