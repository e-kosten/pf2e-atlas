      ...
      anchorTerms: [
        {
          ...
          lift: 2,
          score: 4,
          examples: ["Ghost Commoner"],
        },
      ],
      contrastRecords: [{ recordKey: "creature:guard", name: "Sunny Guard", similarity: 0.81 }],
      cohorts: [
        {
          ...
          reviewFlags: [],
          representativeRecords: [{ recordKey: "creature:wraith", name: "Harbor Wraith", similarity: 0.95 }],
          score: 0.78,
