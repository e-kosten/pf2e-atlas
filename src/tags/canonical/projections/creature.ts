...
const CREATURE_DERIVED_TAG_CANONICAL_PROJECTIONS_BY_TAG_SEEDS: Record<string, CanonicalProjectionSeed> = {
  abaddon_setting: {
...
export const CREATURE_DERIVED_TAG_CANONICAL_PROJECTIONS_BY_TAG = buildProjectionRecord(
  CANONICAL_VOCABULARY.CATEGORY.CREATURE,
  CREATURE_DERIVED_TAG_CANONICAL_PROJECTIONS_BY_TAG_SEEDS,
);
