...
export const AFFLICTION_DERIVED_TAG_ONTOLOGY = {
  ...
  families: {
    impact: {
      ...
      tags: [
        ...
        },
        {
          ...
          description:
            "Dulls thought, memory, decision-making, or mental clarity without being just fear or confusion.",
          assignmentMode: "deterministic",
        },
        {
    ...
    epidemiological_profile: {
      axis: "disease_model",
      description:
        "Affliction tags for outbreak scale, vector style, and contagion-facing retrieval such as quarantine, source tracing, and settlement risk.",
      tags: [
        {
    ...
    response_profile: {
      axis: "response",
      description:
        "Affliction tags for the GM-facing response problem: quarantine, tracing the source, outbreak management, and how urgently a cure must be found.",
      tags: [
        {
    ...
    resolution_profile: {
      axis: "response",
      description:
        "Affliction tags for the kinds of remedies, containment plans, or cleanup answers the condition naturally asks for.",
      tags: [
        {
      ...
      tags: [
        {
          tag: "compulsion",
          description:
            "Overrides agency through commanded behavior, forced truth-telling, or similarly scripted actions.",
          assignmentMode: "deterministic",
        },
        {
    ...
    delivery_profile: {
      axis: "disease_model",
      description:
        "Affliction tags for how exposure or transmission enters the body, breath, bloodstream, or dreaming mind.",
      tags: [
        {
    ...
    progression_profile: {
      axis: "disease_model",
      description:
        "Affliction tags for pacing, relapse patterns, and how the condition escalates toward its end state.",
      tags: [
        {
          tag: "delayed_onset",
          description:
        ...
        },
        {
          tag: "recurrent_flare",
          description:
            "Affliction that subsides and returns in episodes, repeating attacks, or cyclical symptom spikes.",
          assignmentMode: "hybrid",
          appliesWhen: [
        ...
        },
        {
          ...
          description:
            "Affliction whose stages progressively rewrite the victim into a visibly altered or corrupted form.",
          assignmentMode: "hybrid",
          appliesWhen: [
    ...
    physiology_override: {
      axis: "effect",
      description:
        "Affliction tags for forced breathing failure, catastrophic body change, and organ-level disruption.",
      tags: [
        {
        ...
        },
        {
          ...
          description:
            "Progressively transforms the body into crystal, plant matter, fungus, or another corrupted form.",
          assignmentMode: "deterministic",
        },
        {
