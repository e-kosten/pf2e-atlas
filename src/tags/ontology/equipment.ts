...
export const EQUIPMENT_DERIVED_TAG_ONTOLOGY = {
  ...
  families: {
    ...
    consumable_role: {
      ...
      subcategories: ["consumable"],
      description:
        "Consumable role tags for whether an item is primarily hostile, self-directed, or meant to aid another creature.",
      tags: [
        {
          tag: "offensive",
    ...
    delivery_profile: {
      ...
      subcategories: ["consumable"],
      description:
        "Consumable delivery tags for how a hostile item is applied, delivered, or introduced to the target.",
      tags: [
        {
          tag: "weapon_applied",
    ...
    movement_traversal: {
      ...
      tags: [
        ...
        },
        {
          ...
          compositeOfAny: [fromFamily("movement_traversal")],
        },
      ],
    },
    reconnaissance: {
      ...
      subcategories: ["gear", "backpack", "kit", "vehicle", "armor", "weapon"],
      description:
        "Equipment for recon, field observation, visibility support, evidence capture, and tracking or anti-tracking work.",
      tags: [
        {
          tag: "scouting",
        ...
        },
        {
          ...
          compositeOfAny: [fromFamily("reconnaissance")],
        },
      ],
    },
    access_bypass: {
      ...
      subcategories: ["gear", "backpack", "kit", "vehicle", "armor", "weapon"],
      description:
        "Equipment for technical or precision bypass of locks, traps, and secured access points without folding force-entry tools into the same bucket.",
      tags: [
        {
          tag: "lock_bypass",
    ...
    offensive_profile: {
      ...
      description:
        "Hostile consumable and ammunition tags for bombs, payloads, smoke effects, sticky control, and other offensive retrieval patterns that are not just status impairments.",
      tags: [
        {
          tag: "burst_damage",
          description:
    ...
    party_role: {
      axis: "party_role",
      description:
        "Party-facing retrieval tags for loot that is valuable because of who benefits from it in a party or build.",
      tags: [
        {
          tag: "defender_support",
          description:
            "Especially valuable to shield users, bodyguards, line-holders, or other defender-style characters.",
          assignmentMode: "hybrid",
        },
        {
    ...
    play_pattern: {
      axis: "party_role",
      description:
        "Build- and play-pattern-facing retrieval tags for loot that is valuable because of the recurring tactics or workflows it supports.",
      tags: [
        {
          tag: "shield_support",
          description:
      ...
      tags: [
        {
          tag: "medical_support",
          description:
            "Supports first aid, diagnosis, treatment, or ongoing medical care outside direct magical healing.",
          assignmentMode: "deterministic",
        },
        {
          tag: "repair_support",
        ...
        },
        {
          ...
          description:
            "Supports alchemical preparation, formula work, reagent handling, or crafting-related field setup.",
          assignmentMode: "deterministic",
        },
        {
          tag: "forgery_support",
    ...
    resolution: {
      ...
      subcategories: ["gear", "backpack", "kit", "consumable"],
      description:
        "Equipment used to break curses, support appeasement rites, sanctify spaces, trace hidden sources, contain spread, clean corrupted sites, or deal with a problem at its source.",
      tags: [
        {
          tag: "curse_removal",
          description:
    ...
    access_system: {
      ...
      tags: [
        ...
        },
        {
          tag: "weapon_staging",
          description:
            "Holsters, sheaths, scabbards, or bandoliers that stage weapons for quick draw or organized carry.",
          assignmentMode: "deterministic",
        },
        {
          tag: "ammo_management",
    ...
    breaching: {
      ...
      description:
        "Equipment built to force entry, open routes through barriers, or dismantle hardened environmental features.",
      tags: [
        {
          tag: "door_breaching",
          description:
        ...
        },
        {
          tag: "demolition",
          description:
            "Designed for blasting, collapsing, or otherwise violently dismantling structures and obstacles.",
          assignmentMode: "deterministic",
        },
        {
          tag: "breaching",
          ...
          compositeOfAny: [fromFamily("breaching")],
        },
      ],
    },
    impact: {
    ...
    expedition: {
      ...
      description:
        "Field-sustainment equipment for expedition travel, provisioning, camp life, aquatic operations, and hostile-environment endurance.",
      tags: [
        {
          tag: "survival",
        ...
        },
        {
          tag: "camp_setup",
          description:
            "Supports campsite creation, resting infrastructure, shelter setup, or extended overland staging.",
          assignmentMode: "deterministic",
          appliesWhen: [
        ...
        },
        {
          ...
          compositeOfAny: [fromFamily("expedition")],
        },
      ],
    },
    communication: {
    ...
    defense_profile: {
      ...
      description:
        "Shield and armor tags for interception, cover, and protection against ranged fire, hazardous scenes, or vertical danger.",
      tags: [
        {
          tag: "ally_cover",
    ...
    security: {
      ...
      subcategories: ["gear", "backpack", "kit", "vehicle", "consumable"],
      description:
        "Intrusion-warning, anti-surveillance, seal-checking, and after-the-fact security gear for camps, vaults, cargo, and protected rooms.",
      tags: [
        {
          tag: "alarm",
        ...
        },
        {
          ...
          compositeOfAny: [fromFamily("security")],
        },
      ],
    },
  },
