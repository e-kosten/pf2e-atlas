...
export const CREATURE_DERIVED_TAG_ONTOLOGY = {
  ...
  families: {
    ...
    setting: {
      axis: "legacy",
      description:
        "Legacy umbrella family preserved for compatibility. Use the narrower creature setting families instead.",
    ...
    habitat_setting: {
      axis: "setting",
      description:
        "Creature habitat tags for terrain, climate, and ecological placement such as aquatic, desert, sky, or underground retrieval.",
      variantInheritance: true,
      tags: [
        {
          tag: "aquatic_setting",
    ...
    site_setting: {
      axis: "setting",
      description:
        "Creature site and scene-placement tags for ships, settlements, ruins, temples, battlefields, graveyards, and other encounter locations.",
      variantInheritance: true,
      tags: [
        {
    ...
    regional_setting: {
      axis: "setting",
      description:
        "Creature setting tags for broad Golarion macro-regions plus portable thematic macro-regions derived from iconic Pathfinder settings when those lenses materially affect encounter planning and retrieval.",
      variantInheritance: true,
      tags: [
        {
    ...
    planar_setting: {
      ...
      tags: [
        ...
        },
        {
          ...
          description:
            "Strongly associated with the First World, fey realms, or thin-boundary crossings into that plane.",
          assignmentMode: "hybrid",
        },
        {
    ...
    combat_role: {
      axis: "encounter",
      description:
        "Creature combat-role tags for encounter assembly, tactical reading, and balancing mixed enemy groups.",
      tags: [
        {
          tag: "brute_combatant",
          description:
        ...
        },
        {
          ...
          description:
            "Built around stealth openings, surprise rounds, sudden strike pressure, or hidden attack vectors.",
          assignmentMode: "hybrid",
          appliesWhen: [
    ...
    cohort_role: {
      axis: "encounter",
      description:
        "Creature roster-construction tags for the kinds of crews, patrols, cult cells, packs, and retinues a creature naturally belongs to in a scene.",
      tags: [
        {
          tag: "patrol_member",
          description:
    ...
    scene_role: {
      axis: "npc_role",
      description:
        "Creature immediate-scenario tags for how a role-defined NPC or humanoid is used in an active scene, separate from broader job, office, or institutional identity.",
      tags: [
        {
          tag: "civic_npc",
    ...
    social_role: {
      axis: "npc_role",
      description:
        "Creature social-role tags for jobs, offices, institutions, and social identities that matter outside one immediate encounter slot.",
      tags: [
        {
          tag: "profession_npc",
        ...
        },
        {
          tag: "merchant_npc",
          description:
            "Presented as a trader, broker, shopkeeper, caravan factor, or other commerce-facing role-holder.",
          assignmentMode: "editorial",
          appliesWhen: [
        ...
        },
        {
          tag: "performer_npc",
          description:
            "Presented as a musician, actor, dancer, herald, jester, or other entertainment-facing role-holder.",
          assignmentMode: "editorial",
          appliesWhen: [
    ...
    ontology_cluster: {
      axis: "specialization",
      description:
        "Creature semantic groupings that aggregate fragmented native ontology when exact traits are too narrow.",
      tags: [
        {
          tag: "undead_adjacent",
    ...
    casting_profile: {
      axis: "specialization",
      description:
        "Creature prep-driving casting tags for encounter planning, tradition-aware counterplay, and shortlist searches.",
      tags: [
        {
    ...
    corruption_profile: {
      axis: "specialization",
      description:
        "Creature-facing corruption and taint tags for retrieval driven by what kind of blight, infestation, curse, or metaphysical pollution defines the creature.",
      tags: [
        {
          tag: "blight_tainted",
          description:
    ...
    threat_profile: {
      axis: "encounter",
      description:
        "Creature prep-driving threat patterns based on behavior, counterplay, or encounter consequence rather than type.",
      tags: [
        {
        ...
        },
        {
          tag: "spawn_creator",
          description:
            "Creates additional threats through infestation, spawn-making, conversion, or implanted offspring.",
          assignmentMode: "hybrid",
        },
        {
        ...
        },
        {
          tag: "poison_threat",
          description:
            "Threat defined by venom, toxic excretions, poisoned weapons, or other recurring poison delivery.",
          assignmentMode: "hybrid",
        },
        {
          tag: "disease_vector",
    ...
    visual_motif: {
      axis: "presentation",
      description:
        "Creature presentation tags for recurring visual motifs, object imagery, and striking appearance-driven hooks that players and GMs often retrieve by look and iconography.",
      tags: [
        {
          tag: "living_toy",
    ...
    genre_motif: {
      axis: "presentation",
      description:
        "Creature presentation tags for genre-tone, mood, and atmosphere-driven motifs that players and GMs often retrieve by horror flavor or story vibe.",
      tags: [
        {
          tag: "carnival_show",
    ...
    story_motif: {
      axis: "presentation",
      description:
        "Creature presentation tags for narrative framing, social-scene premises, and plot-driving motifs that players and GMs often retrieve by story hook rather than habitat or tactics.",
      tags: [
        {
          tag: "prophecy_omen",
          description:
        ...
        },
        {
          ...
          description:
            "Strongly associated with betrayal, grief, injustice, or a sorrowful wrong returning as vengeance.",
          assignmentMode: "editorial",
          appliesWhen: [
