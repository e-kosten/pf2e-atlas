...
export const HAZARD_DERIVED_TAG_RULES: DerivedTagRule[] = [
  {
    ...
    anyOf: [
      {
        ...
        textAny: [
          ...
          tokenAnchor("seal"),
          tokenAnchor("symbol"),
          tokenAnchor("inscription"),
        ],
      },
      {
        score: 2,
        textAny: [
          phraseAnchor("when triggered"),
          phraseAnchor("when activated"),
          phraseAnchor("when touched"),
          phraseAnchor("when opened"),
          phraseAnchor("when approached"),
          phraseAnchor("when a creature crosses"),
          phraseAnchor("crosses the threshold"),
          phraseAnchor("crosses the ward"),
          phraseAnchor("upon being disturbed"),
          phraseAnchor("set off the rune"),
          phraseAnchor("set off the glyph"),
        ],
      },
      {
        score: 2,
        textNear: [
          ...
          },
          {
            terms: [
              tokenAnchor("trigger"),
              tokenAnchor("triggered"),
              tokenAnchor("activate"),
              tokenAnchor("activated"),
              tokenAnchor("touch"),
              tokenAnchor("touches"),
              tokenAnchor("step"),
              tokenAnchor("steps"),
              tokenAnchor("enter"),
              tokenAnchor("enters"),
              tokenAnchor("approach"),
              tokenAnchor("approaches"),
              tokenAnchor("open"),
              tokenAnchor("opened"),
              tokenAnchor("disturb"),
              tokenAnchor("disturbed"),
              tokenAnchor("cross"),
              tokenAnchor("crosses"),
            ],
            window: 6,
    ...
    noneOf: [
      { textAny: [phraseAnchor("protective ward"), phraseAnchor("warding bell"), phraseAnchor("warded against")] },
    ],
  },
  {
    ...
    anyOf: [
      {
        ...
        textAny: [
          ...
          tokenAnchor("gate"),
          tokenAnchor("gates"),
          tokenAnchor("threshold"),
          tokenAnchor("thresholds"),
          tokenAnchor("doorway"),
          tokenAnchor("doorways"),
          tokenAnchor("entrance"),
          tokenAnchor("entrances"),
          tokenAnchor("portcullis"),
          tokenAnchor("latch"),
          tokenAnchor("lock"),
          tokenAnchor("locks"),
        ],
      },
      {
        ...
        textAny: [
          ...
          phraseAnchor("locks shut"),
          phraseAnchor("seals the door"),
          phraseAnchor("seals the doorway"),
          phraseAnchor("seals the entrance"),
          phraseAnchor("blocks the doorway"),
          phraseAnchor("blocks the entrance"),
          phraseAnchor("bars the passage"),
          phraseAnchor("bars the door"),
          phraseAnchor("drops a portcullis"),
          phraseAnchor("pushes the iron doors closed"),
          phraseAnchor("trap the triggering creature inside"),
          phraseAnchor("traps the triggering creature inside"),
          phraseAnchor("entry and exit seal"),
        ],
      },
      {
        score: 2,
    ...
    noneOf: [
      { textAny: [phraseAnchor("cave in"), phraseAnchor("collapses the tunnel"), phraseAnchor("collapse the passage")] },
    ],
  },
  {
    ...
    anyOf: [
      {
        ...
        textAny: [
          ...
          tokenAnchor("levers"),
          tokenAnchor("console"),
          tokenAnchor("consoles"),
          tokenAnchor("panel"),
          tokenAnchor("panels"),
          tokenAnchor("switch"),
          tokenAnchor("switches"),
          tokenAnchor("dial"),
          tokenAnchor("dials"),
          tokenAnchor("crank"),
          tokenAnchor("cranks"),
          ...
          tokenAnchor("wheels"),
          tokenAnchor("tumbler"),
          tokenAnchor("tumblers"),
        ],
      },
      {
        score: 2,
        textAny: [
          phraseAnchor("press a button"),
          phraseAnchor("press the button"),
          phraseAnchor("push the button"),
          phraseAnchor("pull a lever"),
          phraseAnchor("pull the lever"),
          phraseAnchor("flip the switch"),
          phraseAnchor("operate the console"),
          phraseAnchor("control panel"),
          phraseAnchor("command console"),
          phraseAnchor("turn the crank"),
          phraseAnchor("set the tumbler"),
          phraseAnchor("button mash"),
        ],
      },
      {
        score: 2,
        textNear: [
          ...
          },
          {
            terms: [
              ...
              tokenAnchor("turns"),
              tokenAnchor("operate"),
              tokenAnchor("operates"),
              tokenAnchor("activate"),
              tokenAnchor("activates"),
              tokenAnchor("control"),
              tokenAnchor("controls"),
              tokenAnchor("set"),
            ],
            window: 5,
            scope: "description",
  ...
  },
  {
    ...
    anyOf: [
      {
        ...
        textAny: [
          ...
          tokenAnchor("rifts"),
          tokenAnchor("breach"),
          tokenAnchor("breaches"),
          tokenAnchor("tear"),
          tokenAnchor("tears"),
          tokenAnchor("fissure"),
          tokenAnchor("fissures"),
          tokenAnchor("opening"),
          tokenAnchor("openings"),
          tokenAnchor("void"),
          tokenAnchor("aperture"),
        ],
      },
      {
        score: 2,
        textAny: [
          phraseAnchor("planar breach"),
          phraseAnchor("open a portal"),
          phraseAnchor("opens a portal"),
          phraseAnchor("open a rift"),
          phraseAnchor("opens a rift"),
          phraseAnchor("tear in reality"),
          phraseAnchor("tears in reality"),
          phraseAnchor("tear in the fabric of reality"),
          phraseAnchor("tear the fabric of reality"),
          phraseAnchor("reality tears open"),
          phraseAnchor("unstable rift"),
          phraseAnchor("unstable portal"),
          phraseAnchor("hole in reality"),
          phraseAnchor("breach in reality"),
          phraseAnchor("gate to the"),
          phraseAnchor("portal network"),
        ],
      },
      {
        score: 2,
    ...
    noneOf: [
      { textAny: [phraseAnchor("teleportation circle"), phraseAnchor("safe portal"), phraseAnchor("portal travel"), phraseAnchor("protective ward"), phraseAnchor("ward against portals")] },
    ],
  },
  {
    tag: "alarm",
