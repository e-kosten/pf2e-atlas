...
const DISGUISED_PRETENDER_CONTEXT_TEXT_NEAR = [
  {
    all: [
      ...
      patternAnchor("identity"),
      patternAnchor("impersonate"),
      patternAnchor("impersonates"),
      patternAnchor("infiltrate"),
      patternAnchor("infiltrates"),
      patternAnchor("masquerade"),
      patternAnchor("pretend"),
      patternAnchor("pretender"),
      patternAnchor("replace"),
      patternAnchor("form"),
      patternAnchor("guise"),
    ],
    window: 6,
        ...
        textNear: [
          {
            all: [
              ...
              patternAnchor("constrict"),
              patternAnchor("constricts"),
              patternAnchor("swallow"),
              patternAnchor("snatch"),
              patternAnchor("snatches"),
              patternAnchor("drag"),
              patternAnchor("drags"),
              patternAnchor("carry off"),
              patternAnchor("carries off"),
            ],
            window: 7,
            scope: "description",
          },
        ...
        textNear: [
          ...
          },
          {
            all: [
              ...
              patternAnchor("haunts"),
              patternAnchor("dwells"),
              patternAnchor("lurks"),
              patternAnchor("patrols"),
              patternAnchor("watches over"),
              patternAnchor("buried"),
              patternAnchor("dead"),
            ],
            window: 6,
            scope: "description",
        ...
        textNear: [
          {
            all: [
              ...
              patternAnchor("crumbling"),
              patternAnchor("fallen"),
              patternAnchor("collapsed"),
              patternAnchor("hall"),
      ...
      { score: 1, textNear: [
        {
          all: [
            ...
            patternAnchor("veil"),
            patternAnchor("veiled"),
            patternAnchor("face"),
            patternAnchor("faces"),
            patternAnchor("head"),
            patternAnchor("features"),
      ...
      { score: 1, textNear: [
        {
          all: [
            ...
            patternAnchor("featureless"),
            patternAnchor("blank"),
            patternAnchor("empty"),
            patternAnchor("stolen"),
            patternAnchor("gone"),
