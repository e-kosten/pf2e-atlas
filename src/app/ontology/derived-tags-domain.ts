...
function buildTagNode(tag: DerivedTagOntologyExplorerTagNode): OntologyNode {
  return {
    ...
    detailLines: [
      ...
      ...(tag.label !== tag.tag ? [{ text: `Internal id: ${tag.tag}` }] : []),
...
function buildFamilyNode(family: DerivedTagOntologyExplorerFamilyNode): OntologyNode {
  return {
    ...
    listLabel: `${family.label} | ${family.tagCount} tags | ${family.liveRecordCount} live records`,
    detailTitle: "Family Details",
    detailLines: [
      { text: family.label, tone: "section" },
      ...(family.label !== family.family ? [{ text: `Internal id: ${family.family}` }] : []),
