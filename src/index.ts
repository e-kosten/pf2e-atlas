      ...
      return {
        ...
        structuredContent: {
          supportedFilters: [
            ...
            {
              name: "glossaryFamiliesAny",
              strength: "source-backed family hint",
              description: "Use creature-family metadata from the bestiary glossary for soft narrowing such as ghost, vampire, or lich.",
            },
            {
              name: "glossaryFamiliesAll",
              strength: "source-backed family backstop",
              description: "Require all listed glossary families across the union of primary and additional family metadata.",
            },
            {
              name: "excludeGlossaryFamilies",
              strength: "source-backed family exclusion",
              description: "Exclude records with listed glossary families such as omitting vampire or ghost families.",
            },
            {
              name: "derivedTagsAny",
          ...
          tagGuidance: {
            ...
            glossaryFamiliesAny: "Source-backed creature-family metadata. Matches against the union of primary glossaryFamily and additionalGlossaryFamilies.",
            glossaryFamiliesAll: "Source-backed creature-family metadata. Require every listed family across primary and additional glossary family values.",
            excludeGlossaryFamilies: "Source-backed creature-family metadata. Exclude records whose primary or additional glossary families contain any listed family.",
  ...
  server.registerTool(
    "pf2e_list_records",
    {
      ...
      inputSchema: {
        ...
        glossaryFamiliesAll: z.array(z.string()).optional().describe("All listed glossary families must be present across primary and additional family metadata."),
        glossaryFamiliesAny: z.array(z.string()).optional().describe("At least one listed glossary family must be present across primary and additional family metadata."),
        excludeGlossaryFamilies: z.array(z.string()).optional().describe("Listed glossary families must not be present across primary and additional family metadata."),
