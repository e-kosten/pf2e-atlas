...
- [`0023-rust-cli-json-contract.md`](./0023-rust-cli-json-contract.md): CLI JSON uses one envelope, a shared-base tagged entity `RecordJson`, presence-based detail hydration without empty placeholders, explicit raw opt-in, and standard exit-code classes.
