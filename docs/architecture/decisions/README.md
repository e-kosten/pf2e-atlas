...
- [`0021-rust-runtime-index-and-retrieval-boundaries.md`](./0021-rust-runtime-index-and-retrieval-boundaries.md): runtime path policy belongs to `atlas-runtime`, SQLite access belongs to `AtlasIndex`, and product retrieval routes through `AtlasRetrievalService`.
