...
- [`0035-atomic-canonical-artifact.md`](./0035-atomic-canonical-artifact.md): artifact contract v6/schema v4 stores and completely hydrates canonical creatures, hazards, spells, and consumable spell children without duplicate hydration models or obsolete sparse activity/spellcasting tables.
