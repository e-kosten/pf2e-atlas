...
Read ADR 0001 first for the top-level surface split, then ADR 0002 for ontology and storage boundaries, ADR 0003 for tag/editorial enforcement, and ADR 0004 for the non-tag ownership import rules that keep broad shared pathways from regrowing.
