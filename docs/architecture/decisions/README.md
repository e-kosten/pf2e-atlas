...
- [`0020-rust-content-documents.md`](./0020-rust-content-documents.md): records preserve authored rich text as `ContentDocument`, with presentation, FTS, semantic chunks, and reference edges derived from that canonical content model.
- [`0021-rust-runtime-index-and-retrieval-boundaries.md`](./0021-rust-runtime-index-and-retrieval-boundaries.md): runtime path policy belongs to `atlas-runtime`, SQLite access belongs to `SqliteIndexReader`, and product retrieval routes through `AtlasRetrievalService`.
