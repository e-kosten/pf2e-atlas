...
| Non-tag imports of tag internals | No non-tag module outside an approved facade                                                                                                                                                               | Most non-tag code cannot import `src/tags/runtime/**`, `authored-rules/**`, `catalog/**`, `ontology/**`, `exemplars/**`, `legacy-rules/**`, or `legacy-seed-migrations/**`                     | Re-export through `src/tags/index.ts` or a dedicated approved facade; legacy folders are migration-only compatibility inputs, not stable integration points |
