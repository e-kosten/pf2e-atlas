    ...
    fn uses_json(&self) -> bool {
        match self {
            ...
            Self::Lists(lists) => match &lists.command {
                ...
                ListsCommand::Export(_) => false,
                ListsCommand::Import(options) => options.json,
                ListsCommand::Edit(options) => options.json,
...
fn run(cli: Cli) -> Result<ExitCode, String> {
    match cli.command {
        ...
        Command::Lists(lists) => match lists.command {
            ...
            ListsCommand::Export(options) => commands::lists::run_lists_export(options),
            ListsCommand::Import(options) => commands::lists::run_lists_import(options),
            ListsCommand::Edit(options) => commands::lists::run_lists_edit(options),
