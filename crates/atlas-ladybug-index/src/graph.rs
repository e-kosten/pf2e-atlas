...
impl LadybugIndex {
    ...
    pub(crate) fn reference_edges_impl(&self) -> Result<Vec<ReferenceEdge>, LadybugIndexError> {
        query_rows(
            &self.connection,
    ...
    pub(crate) fn remaster_links_impl(&self) -> Result<Vec<RemasterLink>, LadybugIndexError> {
        query_rows(
            &self.connection,
