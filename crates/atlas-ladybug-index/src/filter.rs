...
use crate::{LadybugIndexError, string_literal, unsupported};
...
) -> Result<CompiledScope, LadybugIndexError> {
...
pub(crate) fn sort_clause(sort: FilteredRecordSort) -> Result<&'static str, LadybugIndexError> {
    match sort {
