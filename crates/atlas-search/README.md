...
Product surfaces should use this crate for retrieval instead of assembling `atlas-index` and `atlas-embedding` directly. Keep lower-level semantic/vector helpers private unless they are durable product boundaries.
