...
`atlas index build` generates MiniLM document embeddings in batches by default; pass `--embedding-batch-size <count>` to compare batch sizes during performance work.
