...
pub use sql::{
    ...
    record_trait_insert_sql, records_fts_insert_sql, reference_edge_select_sql,
...
pub use tables::{
    ...
    REQUIRED_COLUMNS, REQUIRED_TABLES, SPELL_RECORD_COLUMNS, TABLE_ACTOR_RECORDS,
    TABLE_ARTIFACT_METADATA, TABLE_DOCUMENT_EMBEDDING_CACHE, TABLE_ITEM_RECORDS,
    ...
    metric_value_catalog, packs, record_aliases, record_metrics, record_traits, records,
