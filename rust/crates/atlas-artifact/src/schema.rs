...
pub use sql::{
    ...
    create_artifact_schema_sql, document_embedding_cache_insert_sql, insert_or_ignore_sql,
...
pub use tables::{
    ...
    RECORD_METRIC_COLUMNS, RECORD_TRAIT_COLUMNS, RECORD_VECTOR_INDEX_COLUMNS, RECORDS_FTS_COLUMNS,
    REFERENCE_EDGE_COLUMNS, REMASTER_LINK_COLUMNS, SPELL_RECORD_COLUMNS, TABLE_ACTOR_RECORDS,
    TABLE_ARTIFACT_METADATA, TABLE_DESCRIPTORS, TABLE_DOCUMENT_EMBEDDING_CACHE, TABLE_ITEM_RECORDS,
    TABLE_METRIC_KEY_CATALOG, TABLE_METRIC_VALUE_CATALOG, TABLE_PACKS, TABLE_RECORD_ALIASES,
    TABLE_RECORD_CONTENT, TABLE_RECORD_METRICS, TABLE_RECORD_TRAITS, TABLE_RECORD_VECTOR_INDEX,
    ...
    metric_key_catalog, metric_value_catalog, packs, record_aliases, record_content,
    record_metrics, record_traits, record_vector_index, records, records_fts, reference_edges,
    remaster_links, required_columns, required_tables, spell_records, table_descriptor,
};
