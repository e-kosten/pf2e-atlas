...
use crate::generated_affliction_identity::build_affliction_occurrence_candidate_keys;
use crate::generated_afflictions::source_facts::{
...
use crate::normalize::{extract_traits, string_field};
use crate::references::record_by_key;
use crate::{AfflictionOccurrence, LoadedRecord, RecordReferenceIndex, variants};
